...
export default function FollowingScreen() {
  ...
  const qKey = ["/api/users", userId, "following"];
    ...
    <View style={[styles.flex, { backgroundColor: colors.background }]}>
      ...
      {isLoading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={{ color: colors.mutedForeground, fontWeight: "700", fontSize: 16 }}>Not following anyone</Text>
        </View>
      ) : (
        <FlatList
          data={data}
              ...
              >
                ...
                {!isSelf && me && (
                  <TouchableOpacity
                    ...
                    onPress={() => u.isFollowing ? unfollowMutation.mutate(u.id) : followMutation.mutate(u.id)}
                    activeOpacity={0.8}
                  >
